...
Connect-PnPOnline -Url https://mydomain.sharepoint.com/sites/SPSLeicester
...
New-PnPTenantSite -Title "Group-less Team Site" -Url https://mydomain.sharepoint.com/sites/SPSLeicesterGroupless -Description "Group-less Team Site" -Owner Andy@mydomain.onmicrosoft.com -Template STS#3 -TimeZone 2



# Content types, templates, libraries, views
# An aside first
Connect-PnPOnline -Url https://mydomain.sharepoint.com/sites/SPSLeicester -CreateDrive
...
# Create the content type - specify your own ID
...
# ... and removing the original default - Note that this needs to not be in use for this to be allowed
...
Connect-PnPOnline -Url https://mydomain.sharepoint.com/sites/SPSLeicester
$node = Add-PnPNavigationNode -Location TopNavigationBar -Title "Top Level" -Url "/sites/Test1/" # Top level node
$node2 = Add-PnPNavigationNode -Location TopNavigationBar -Title "Sub-Level" -Url "/sites/Test2/" -Parent $node.id
$node3 = Add-PnPNavigationNode -Location TopNavigationBar -Title "Sub-Sub-Level" -Url "/sites/Test3/" -Parent $node2.id
...
# Required Parameters 
$SiteUrl = "https://mydomain.sharepoint.com/sites/SPSLeicester"
...
Add-PnPClientSidePageSection -Page "MyPage" -SectionTemplate ThreeColumn -Order 1
Add-PnPClientSidePageSection -Page "MyPage" -SectionTemplate ThreeColumn -Order 2
Add-PnPClientSidePageSection -Page "MyPage" -SectionTemplate ThreeColumn -Order 3
